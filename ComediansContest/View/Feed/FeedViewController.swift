...
extension FeedViewController: ListAdapterDataSource {
    func objects(for _: ListAdapter) -> [ListDiffable] {
        ...
        let content1: Content = Content(id: "content1", type: .image, title: "静止画がっきー", comment: "comment", image: UIImage(named: "gacky")!, url: nil, funnies: 100, tags: ["food", "movie"])
        let content2: Content = Content(id: "content2", type: .video, title: "動画がっきー", comment: "testtest", image: UIImage(named: "gacky")!, url: nil, funnies: 1000, tags: ["test", "sports"])
